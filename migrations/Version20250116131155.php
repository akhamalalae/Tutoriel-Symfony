 ...
 */
final class Version20250116131155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussion_message_user ADD CONSTRAINT FK_DC70602EAB0FA336 FOREIGN KEY (answer_to_id) REFERENCES message (id)');
