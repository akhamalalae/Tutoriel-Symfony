 ...
 */
final class Version20250116161053 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer_message ADD CONSTRAINT FK_FEFDFF0E616AB49D FOREIGN KEY (discussion_message_user_id) REFERENCES discussion_message_user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
